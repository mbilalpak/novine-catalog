                        ...
                        <div className="row align-items-center">
                            <div className="col-lg-6 col-md-6">
                                <div className="productQuickView-image">
                                    <img style={{ height: '400px', width: '400px' }} src={this.props.image} alt="image" />
                                </div>
                            </div>
                            ...
                            <div className="col-lg-6 col-md-6">
                                <div className="product-content">
                                    ...
                                    <div className="price">
                                        <span className="new-price">Location: {this.props.price}</span>
                                    </div>
                                    ...
                                    <div >
                                        <span >MIN: {this.props.minOrder} </span>
                                    </div>
                                    <div >
                                        <span>Unit:  {this.props.Unit}</span>
                                    </div>
