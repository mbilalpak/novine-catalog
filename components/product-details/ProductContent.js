                ...
                <div className="col-lg-6 col-md-6">
                    ...
                    <div className="product-details-content">
                        ...
                        <div className="product-price">
                            <span className="new-price">Location: {product[0].adpCustomersDTO.city + "," + product[0].adpCustomersDTO.country}</span>
                        </div>
                        <div className="product-price">
                            <span className="new-price">Availability: {product[0].instock}</span>
                        </div>
                        <div >
                            <span >Min Order: {product[0].minOrder} </span>
                        </div>
                        <div>
                            <span >Unit:  {product[0].unitOfMeasure}</span>
                        </div>
